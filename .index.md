...
- Vilka är de studerande från utbildningen _Objektorienterad programmering med AI-kompetens_ från Handelsakademin Halmstad som gör sin LIA hos oss?
...
- _Samt:_ Ni [läser artiklarna på bloggen](https://lia.nodehill.se), diskuterar dessa gemensamt och börjar därefter er gemensamma sprintplanering!
...
Thomas har arbetat med IT- och webbutveckling i 25 år – webb, e-böcker och digitala läromedel – bl.a. i en nyckelroll som _Digital Development Manager_ på Studentlitteratur. Undervisar på YH-nivå och universitetsnivå sedan 2013 (över 10 000 timmars hittills).
...
- Möten tillsammans med Mattias och Thomas sker som _Google Meet_-möten. De spelas även in, så att ni kan gå tillbaka till dem.
...
- I _den första sprinten_ sätter SCRUM-master upp ett GitHub-repo och bjuder in [alla på mail-listan](#3) till det.
...
- Möte med Mattias sker 1-2 ggr per vecka (totalt 1 timmes möte/vecka). Var väl förberedd och ta upp relevanta frågor och problem. _De veckor en sprint avslutas sker även sprintredovisning vid mötet med Mattias._
